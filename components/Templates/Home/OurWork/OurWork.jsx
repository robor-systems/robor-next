        ...
        >
          ...
          <Link href="/work" passHref>
            <motion.a
              ...
              animate={visible ? "visible" : "invisible"}
              transition={{ duration: 1 }}
              className="rounded-xl font-semibold flex items-center justify-center px-6 py-4 space-x-2 border-[3px] dark:border-dark-primary border-light-primary text-light-primary dark:text-dark-primary"
            >

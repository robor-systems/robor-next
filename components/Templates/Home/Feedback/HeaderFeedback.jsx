const HeaderFeedback = () => {
  return (
    <div className="flex flex-col justify-center flex-1 gap-8 text-center lg:gap-12 lg:text-left">
      <h1 className="text-3xl sm:text-5xl lg:text-7xl font-extrabold bg-gradient-to-r from-primary-dark dark:from-[#FEFEFE] to-[#004f53] dark:to-[#F3F7F9] bg-clip-text text-transparent">

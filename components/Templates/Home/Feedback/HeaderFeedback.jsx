const HeaderFeedback = () => {
  return (
    <div className="flex flex-col justify-center flex-1 gap-8 text-center lg:gap-12 lg:text-left">
      <h1 className="text-3xl sm:text-5xl lg:text-7xl leading-[2.5rem] sm:leading-[4.25rem] lg:leading-[5.75rem] font-extrabold bg-gradient-to-r from-primary-dark dark:from-[#FEFEFE] to-[#004f53] dark:text-dark-primary bg-clip-text text-transparent ">

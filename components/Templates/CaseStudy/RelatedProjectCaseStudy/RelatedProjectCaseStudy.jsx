...
const RelatedProjectCaseStudy = ({ title, slug, description, ...props }) => {
  return (
    <div
      className={clsx(
        "md:py-24 py-16 md:px-10 lg:px-20 xl:px-44 px-8",

        "bg-light-bgSecondary dark:bg-dark-bgSecondary"
      )}
    >
      <div className={clsx("grid grid-cols-5 gap-10", "container mx-auto")}>
        {/* * left content */}
        ...
        <div className="flex items-center justify-start md:justify-end md:col-span-2 col-span-full ">
          <Link href={`/clients/${slug}`} className="outline-link hover:bg-light-primary hover:dark:bg-dark-primary hover:text-[#fff]">
